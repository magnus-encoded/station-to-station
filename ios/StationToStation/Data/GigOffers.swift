...
struct GigAsKnown {
    ...
    ///
    /// Comes off `StoredAttendance.ticketQr`, the field #412 writes and Android's #411
    /// already wrote. Bytes rather than the stored base64 because that is what a
    /// barcode is; the decoding is the store's, not this fold's.
