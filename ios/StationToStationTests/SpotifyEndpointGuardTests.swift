...
final class SpotifyEndpointGuardTests: XCTestCase {
    ...
    private var source: String {
        get throws {
            // Test file lives in ios/StationToStationTests/; source in ios/StationToStation/…
            let dir = URL(fileURLWithPath: #filePath).deletingLastPathComponent().deletingLastPathComponent()
            let file = dir.appendingPathComponent("StationToStation/Data/Spotify/SpotifyClient.swift")
