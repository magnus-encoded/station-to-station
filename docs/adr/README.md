...
| [0019](0019-the-extension-deposits-the-app-disposes.md) | The extension deposits, the app disposes | accepted |
...
and 0017 is the one an iOS session most often needs first. 0019 before adding a second process on
